...
status = cycle(['$chat to talk to me', f'in {server_count()} servers'])
...
async def invite(ctx):
  ...
  invite = 'https://discord.com/api/oauth2/authorize?client_id=696276538672414733&permissions=8&scope=bot'
